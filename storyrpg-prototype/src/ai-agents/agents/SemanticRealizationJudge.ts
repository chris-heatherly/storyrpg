...
export class SemanticRealizationJudge extends BaseAgent implements SemanticRealizationJudgeLike {
  ...
  private buildPrompt(claims: SemanticRealizationClaim[]): string {
    ...
    return [
      ...
      'For a relationship_change proposition, require observable behavior that establishes changed footing rather than a label, smile, chemistry, or toast alone. Mutual transitions such as friendship, alliance, bonding, or reconciliation require a personal bid plus acceptance or reciprocal behavior; unilateral transitions such as betrayal, rejection, estrangement, intimidation, or trust loss may be fulfilled by one character\'s decisive act and its observable relational consequence.',
