...

{
  ...
  "views": [
    ...
    },
    {
      ...
      "prompt": {
        "prompt": "${this.artStyle ? `Art style: ${this.artStyle}. ` : ''}[full character description], three-quarter view, 45 degree angle, characteristic pose, full body visible, character fills frame, plain solid gray background, soft studio lighting, clean full-body character identity reference${this.artStyle ? `. Rendered in the art style specified above — do not substitute a generic illustrated or graphic-novel look.` : ''}",
        "negativePrompt": "background, environment, scenery, props, furniture, cropped, cut off, tiny character, distant, multiple people, text, watermark${this.artStyle ? ', generic illustrated style, default comic-book style, default graphic-novel style' : ''}",
        "aspectRatio": "1:1"
      }
    },
    {
      ...
      "prompt": {
        "prompt": "${this.artStyle ? `Art style: ${this.artStyle}. ` : ''}[full character description], side profile view, entire body rotated 90 degrees facing left, body perpendicular to camera, only one shoulder visible, torso hips and legs all facing sideways, clean side profile fully detailed and colored, full body visible head to toe, same scale as front view, character fills frame, plain solid gray background, soft studio lighting, clean full-body character identity reference${this.artStyle ? `. Rendered in the art style specified above — do not substitute a generic illustrated or graphic-novel look.` : ''}",
...
${this.artStyle
  ...
  : '- Each "prompt" field MUST describe a clean full-body character identity reference and MUST NOT include the phrase "reference sheet style".'}
...
{
  "prompt": "${this.artStyle ? `Art style: ${this.artStyle}. ` : ''}[detailed character description], ${viewDescriptions[viewType]}, plain solid gray background, soft studio lighting, clean full-body character identity reference${this.artStyle ? '. Rendered in the art style specified above — do not substitute a generic illustrated or graphic-novel look.' : ''}",
