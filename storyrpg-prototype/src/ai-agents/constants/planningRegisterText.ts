...
export const PLANNING_REGISTER_LEAK_PATTERNS: Array<{ label: string; pattern: RegExp }> = [
  ...
  { label: 'Visible-consequence coverage scaffold', pattern: /\bTrack\s+the\s+visible\s+consequence\s+of\b/i },
  { label: 'SequenceDirector preserve scaffold', pattern: /\bSequenceDirector:\s*preserve\b/i },
  { label: 'Coverage distance/control scaffold', pattern: /\bshow\s+who\s+gains\s+or\s+loses\s+distance,\s*control,\s*or\s+attention\b/i },
