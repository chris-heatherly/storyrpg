...
export function assembleChoiceForStory(
  ...
  return {
    ...
    relationshipValueEvidence: choice.relationshipValueEvidence,
    relationshipMilestoneId: choice.relationshipMilestoneId,
    relationshipGroupId: choice.relationshipGroupId,
    mechanicPressure: choice.mechanicPressure,
    residueObligationIds: choice.residueObligationIds,
