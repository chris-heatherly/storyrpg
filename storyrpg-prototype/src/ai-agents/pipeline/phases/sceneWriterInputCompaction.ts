...
export function compactSceneWriterInput(input: SceneWriterInput): {
  ...
  const compactScene: RecordLike = {
    ...
    sevenPointBeatContracts: rankedCompactArray(scene.sevenPointBeatContracts, FAMILY_LIMITS.sevenPointBeatContracts, compactContract),
