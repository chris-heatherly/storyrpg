...
function createAnalysis(): SourceMaterialAnalysis {
  return {
    ...
    storyCircle: {
      you: '',
      need: '',
      go: 'The gods call in the bargain.',
      search: 'Her lover is threatened by the divine debt.',
      find: 'Rhea learns the true cost of refusal.',
      take: 'Her defiance nearly destroys the mortal world.',
      return: 'Rhea faces the divine council with her final answer.',
      change: 'The bargain is settled, for better or worse.',
    },
