...
describe('treatmentFidelityGate', () => {
  ...
  it('is default-on (Wave-5 promotion) for every treatment-fidelity gate', () => {
    // GATE_INFORMATION_LEDGER_SCHEDULE is default-on again now that authored INFO
    // entries are parsed, assigned to setup/reveal/payoff phases, and backed by
