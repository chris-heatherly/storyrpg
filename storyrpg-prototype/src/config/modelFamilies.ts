...
export const PIPELINE_TASKS: readonly PipelineTaskMeta[] = [
  ...
  {
    id: 'councilPlan',
    label: 'Council: Candidate Expert',
    description: 'Optional alternate-model StoryArchitect seat for independent planning candidates.',
    crossProvider: true,
  },
  {
    id: 'councilChoice',
    label: 'Council: Choice Expert',
    description: 'Reserved Story Council model route for qualified choice-set candidate tournaments.',
    crossProvider: true,
  },
  {
    id: 'councilPlaytest',
    label: 'Council: Route Holdout',
    description: 'Optional route-simulation critic for cosmetic branching, residue loss, and impossible state.',
    crossProvider: true,
  },
  {
    id: 'councilFinal',
    label: 'Council: Judge + Final Holdout',
    description: 'Independent candidate comparison plus regression-oriented final holdout over story and validator evidence.',
    crossProvider: true,
  },
  {
    id: 'councilFusion',
    label: 'Council: Fusion Holdout',
    description: 'Optional OpenRouter Fusion deep holdout for high-cost-of-being-wrong audits.',
    crossProvider: true,
  },
] as const;
