...
const FALLBACK_ATLAS_MODELS: ModelOption[] = [
  ...
  { value: 'openai/gpt-image-2/text-to-image', label: 'GPT Image 2', description: "OpenAI's default storyboard model on this branch. Best identity/style consistency with multi-reference edit flows." },
  ...
  { value: 'black-forest-labs/flux-dev', label: 'Flux Dev', description: 'Flux-dev 12B parameter rectified flow transformer. Text-to-image only.' },
  { value: 'black-forest-labs/flux-schnell', label: 'Flux Schnell', description: 'FLUX.1 [schnell] — fastest 12B model, great for drafts. Text-to-image only.' },
  { value: 'black-forest-labs/flux-dev-lora', label: 'Flux Dev LoRA', description: 'FLUX.1 [dev] with LoRA tag support for personalized styles. Text-to-image only.' },
  { value: 'black-forest-labs/flux-kontext-dev', label: 'Flux Kontext Dev', description: 'FLUX.1 Kontext [dev] image editor. Requires a reference image.' },
  { value: 'black-forest-labs/flux-kontext-dev-lora', label: 'Flux Kontext Dev LoRA', description: 'FLUX.1 Kontext [dev] with LoRA support for brand/style edits. Requires a reference image.' },
